...
public class pastaman extends AppCompatActivity {
    String [] datab = {"Fettuccine Alfredo", "Mushroom Florentine"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pastaman);
        getWindow().setStatusBarColor(ContextCompat.getColor(this,R.color.colorPrimary));
        RecyclerView rcv = findViewById(R.id.passem);
    ...
    public class MyAdapter extends RecyclerView.Adapter {
        ...
        {
            LayoutInflater li = LayoutInflater.from(pastaman.this);
        ...
        public class MyHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            public void onClick(View v) {
                ...
                {
                    conref1.setValue("shawarma house");
                    Intent ii=new Intent(pastaman.this, cart.class);
