...
public class friedman extends AppCompatActivity {

    String [] datab = {"Fried chicken", "Grilled chicken"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_friedman);
        getWindow().setStatusBarColor(ContextCompat.getColor(this,R.color.colorPrimary));
        RecyclerView rcv = findViewById(R.id.frieen);
    ...
    public class MyAdapter extends RecyclerView.Adapter {
        ...
        {
            LayoutInflater li = LayoutInflater.from(friedman.this);
        ...
        public class MyHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent ii=new Intent(friedman.this, cart.class);
