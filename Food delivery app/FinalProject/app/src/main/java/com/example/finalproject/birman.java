...
public class birman extends AppCompatActivity {
    String [] datab = {"Chicken Biriyani", "Mutton Biriyani"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_birman);

        getWindow().setStatusBarColor(ContextCompat.getColor(this,R.color.colorPrimary));
        RecyclerView rcv = findViewById(R.id.birem);
    ...
    public class MyAdapter extends RecyclerView.Adapter {
        ...
        {
            LayoutInflater li = LayoutInflater.from(birman.this);
        ...
        public class MyHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent ii=new Intent(birman.this, cart.class);
