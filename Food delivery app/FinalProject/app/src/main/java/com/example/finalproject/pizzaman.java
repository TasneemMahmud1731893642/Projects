...
public class pizzaman extends AppCompatActivity {
    String [] datab = {"Meat lovers", "Pizza Margherita"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pizzaman);
        getWindow().setStatusBarColor(ContextCompat.getColor(this,R.color.colorPrimary));
        RecyclerView rcv = findViewById(R.id.pizzem);
    ...
    public class MyAdapter extends RecyclerView.Adapter {
        ...
        {
            LayoutInflater li = LayoutInflater.from(pizzaman.this);
        ...
        public class MyHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent ii=new Intent(pizzaman.this, cart.class);
