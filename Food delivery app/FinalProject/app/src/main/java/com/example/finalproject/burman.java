...
public class burman extends AppCompatActivity {
   ...
   int [] databpi = {250, 350};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_burman);
        getWindow().setStatusBarColor(ContextCompat.getColor(this,R.color.colorPrimary));
        RecyclerView rcv = findViewById(R.id.burnem);
    ...
    public class MyAdapter extends RecyclerView.Adapter {
        ...
        {
            LayoutInflater li = LayoutInflater.from(burman.this);
        ...
        public class MyHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent ii=new Intent(burman.this, cart.class);
